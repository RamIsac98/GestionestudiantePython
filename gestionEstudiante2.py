...
lista_estudinates = []
estudiante1 = Estudiante("ramses","sistemas",18)
estudiante2 = Estudiante("maria","sistemas",17)
estudiante3 = Estudiante("diana","derecho",15)
estudiante4 = Estudiante("rebeca","derecho",18)
estudiante5 = Estudiante("roberto","derecho",18)
estudiante6 = Estudiante("gilberto","electronica",18)
estudiante7 = Estudiante("alicia","civil",18)
...
lista_estudinates.append(estudiante5)
lista_estudinates.append(estudiante6)
lista_estudinates.append(estudiante7)
